...
import cn.halinjin.mybook.dao.RecordDao;
...
public class BookBiz {
    ...
    public int add(Book book){
        return add(book.getTypeId(),book.getName(),book.getPrice(), book.getDesc(), book.getPic(), book.getPublish(), book.getAuthor(), book.getId(), book.getAddress());
    }
