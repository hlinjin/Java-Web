                                            ...
                                            <form action="" method="">
                                                <table width="100%"class="cont">
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>库存量：</td>
                                                        <td width="20%"><input class="text" style="width:50px;" type="number" name="${book.stock}" value="100"  disabled="disabled" /></td>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td></td>
                                                        <td colspan="3" class="btn" type="button" value="返回" onclick="window.location='book?type=query&pageIndex=1';">返回</td>
                                                    </tr>
                                                </table>
                                            </form>
                                        </td>
